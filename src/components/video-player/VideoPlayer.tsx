...
import { EASING_MAP, type TimelineAction, type EasingFn } from './types';
...
function VideoScene({ videoSrc, videoAspect, timeline, loop }: VideoSceneProps) {
  const { viewport } = useThree();

  // Responsive plane: fill viewport while keeping aspect ratio
...
export interface VideoPlayerProps {
  videoSrc: string;
  timeline: TimelineAction[];
  videoAspect?: number;   // default 16/9
