...
export default async function FormalDocPage() {
  const t = await getTranslations('formaldocPage');
      ...
      <SectionWrapper className={styles.stepsSection}>
        ...
        <div className={styles.stepItem}>
          ...
          <div className={styles.stepVisual}>
            <div className={styles.visualPlaceholder}>Template Learning</div>
          </div>
        </div>
        ...
        <div className={styles.stepItem}>
          ...
          <div className={styles.stepVisual}>
            <div className={styles.visualPlaceholder}>Dynamic Content</div>
          </div>
        </div>
        ...
        <div className={styles.stepItem}>
          ...
          <div className={styles.stepVisual}>
            <div className={styles.visualPlaceholder}>Multi-Format</div>
          </div>
        </div>
      </SectionWrapper>
    </>
